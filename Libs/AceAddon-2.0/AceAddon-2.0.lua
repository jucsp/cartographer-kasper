...
elseif GetLocale() == "esES" then
    ...
    ABOUT = "Acerca de"
    PRINT_ADDON_INFO = "Mostrar informacion del addon"
    ...
    CATEGORIES = {
        ...
        ["Buffs"] = "Beneficios",
        ["Chat/Communication"] = "Chat/Comunicacion",
        ["Druid"] = "Druida",
        ["Hunter"] = "Cazador",
        ["Mage"] = "Mago",
        ["Paladin"] = "Paladin",
        ...
        ["Guild"] = "Hermandad",
        ["Frame Modification"] = "Modificacion de marcos",
        ["Interface Enhancements"] = "Mejoras de interfaz",
        ...
        ["Quest"] = "Mision",
        ["Raid"] = "Banda",
        ["Tradeskill"] = "Habilidad comercial",
        ["UnitFrame"] = "Marcos de unidad",
    }
