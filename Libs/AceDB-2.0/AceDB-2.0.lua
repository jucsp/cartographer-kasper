...
elseif GetLocale() == "esES" then -- Spanish translations by Kasper
	...
	ENABLED = "Activado"
	STATE = "Estado"
	TOGGLE_ACTIVE = "Suspender/reanudar este addon."
	MAP_ACTIVESUSPENDED = { [true] = "|cff00ff00Activo|r", [false] = "|cffff0000Suspendido|r" }
	SET_PROFILE = "Establecer perfil para este addon."
	SET_PROFILE_USAGE = "{char || clase || reino || <nombre de perfil>}"
	PROFILE = "Perfil"
	PLAYER_OF_REALM = "%s de %s"
	CHOOSE_PROFILE_DESC = "Elige un perfil."
	CHOOSE_PROFILE_GUI = "Elegir"
	COPY_PROFILE_DESC = "Copia la configuraci\195\179n de otro perfil."
	COPY_PROFILE_GUI = "Copiar de"
