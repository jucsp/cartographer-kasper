...
function GetCustomMapContinents() return unpack({ 'Kalimdor', 'Reinos del Este' }) end
...
L:RegisterTranslations("esES", function () return {
	["Active"] = "Activo",
	["Suspend/resume this module."] = "Suspender/reanudar este módulo.",
	
	["Right-Click on map to zoom out"] = "Clic derecho en el mapa para alejar",
	["Left-Click on map to zoom in"] = "Clic izquierdo en el mapa para acercar",
