...
L:RegisterTranslations("esES", function() return { -- Spanish translations by Kasper
	...
	["Module which turns all your party's and your raid's POIs into circles colored based on class, and shows a number on them based on their raid group."] = "Módulo que convierte todos los POIs de tu grupo y tu banda en círculos coloreados según la clase, y muestra un número en ellos basado en su grupo de banda.",
} end)
