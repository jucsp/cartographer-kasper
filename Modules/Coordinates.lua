...
L:RegisterTranslations("esES", function() return { -- Spanish translations by Kasper
	...
	["Module to add coordinates to the bottom of the world map of the player and the cursor."] = "Módulo que añade coordenadas a la parte inferior del mapa del mundo del jugador y el cursor.",
