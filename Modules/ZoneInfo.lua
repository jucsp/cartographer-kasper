...
L:RegisterTranslations("esES", function() return{ -- Spanish translations by Kasper
	["Zone Info"] = "Zona Info",
	["Module which on hovering over a zone, will show the levels of the zone, the instances in the zone, their levels, and the number of men the instance is made for (e.g. 5-man, 40-man)."] = "Módulo que, al pasar el cursor sobre una zona, mostrará los niveles de la zona, las instancias en la zona, sus niveles y la cantidad de personas para los que está hecha la instancia (por ejemplo, 5 personas, 40 personas).",
