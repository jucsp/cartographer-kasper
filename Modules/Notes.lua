...
if revision > Cartographer.revision then
	...
	Cartographer.date = string.sub("$Date: 2025-04-14 12:55:33 +0300 $", 8, 17)
end
...
L:RegisterTranslations("esES", function () return{ -- Spanish translations by Kasper
	["Notes"] = "Notas",
	["Module which allows you to put notes on the map."] = "Módulo que permite poner notas en el mapa.",
	...
	["Send to party"] = "Enviar a grupo",
	["Send to raid"] = "Enviar a banda",
	["Send to guild"] = "Enviar a hermandad",
	["Send to player"] = "Enviar a jugador",

	["Note: This may be blocked by Blizzard's spam filter and cause problems. It is recommended to send to your party/raid/guild instead."] = "Nota: Esto puede ser bloqueado por el filtro de spam de Blizzard y causar problemas. Se recomienda enviar a tu grupo/banda/gremio en su lugar.",
	...
	["Error: %s sent you a note with an unknown zone: %q"] = "Error: %s te envió una nota con una zona desconocida: %q",
	["Error: %s sent you a note at %q : %.1f, %.1f with the title %q created by %q, but you already have a note at this location."] = "Error: %s te envió una nota en %q : %.1f, %.1f con el título %q creado por %q, pero ya tienes una nota en esta ubicación.",
	["%s sent you a note at %q : %.1f, %.1f with the title %q created by %q."] = "%s te envió una nota en %q : %.2f, %.2f con el título %q creado por %q.",

	["Created by"] = "Creado por",
	
	["Show note creator"] = "Mostrar creador de la nota",
